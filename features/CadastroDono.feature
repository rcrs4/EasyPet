Scenario: Preenchendo os dados do dono
    Given que estou na página “Faça seu cadastro”
    When eu preencher campos os obrigatórios nome, idade, CPF e Fone
    And os campos opicionais E-mail e endereço
    And submeto as informações
    Then sou dirigido para a tela de cadastro realizado
----------------------------------------------------------------------------------------------
